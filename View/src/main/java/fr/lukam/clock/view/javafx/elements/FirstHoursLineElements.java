...
import static fr.lukam.clock.view.utils.RectangleBuilder.aRectangle;

public class FirstHoursLineElements extends Element {

    private static final int SPACING = 85;

    private final List<Rectangle> rectangles = new ArrayList<>();

    public FirstHoursLineElements() {
    ...
    public void update(String[] colors) {
        ...
        for (int i = 0; i < colors.length; i++) {
            ...
            Color color = Color.valueOf(colors[i]);
